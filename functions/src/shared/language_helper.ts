 ...
 */
export function getTrueFalseOptions(language: string = 'pt'): { true: string; false: string; display: string } {
    const options: Record<string, { true: string; false: string; display: string }> = {
 ...
 */
export function getPromptTexts(language: string = 'pt'): Record<string, string> {
 ...
 */
export function getQuizExample(language: string = 'pt'): string {
 ...
 */
export function getFlashcardExample(language: string = 'pt'): string {
    const examples: Record<string, string> = {
        pt: `{
 ...
 */
export function getMindmapExample(language: string = 'pt'): string {
    const examples: Record<string, string> = {
