    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-r from-[#0891B2] to-[#7CB342] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center group"
                title={t('help.button.tooltip')}
                aria-label={t('help.button.tooltip')}
            >
